...
import org.mybatis.generator.codegen.mybatis3.IntrospectedTableMyBatis3CrudImpl;
...
public class ObjectFactory {
    ...
    public static IntrospectedTable createIntrospectedTableForValidation(Context context) {
        ...
        // 自定义 Introspected table 实现类
        } else if ("MyBatis3Crud".equalsIgnoreCase(type)) {
            type = IntrospectedTableMyBatis3CrudImpl.class.getName();
        }
