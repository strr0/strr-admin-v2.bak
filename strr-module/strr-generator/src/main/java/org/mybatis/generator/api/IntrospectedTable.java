...
public abstract class IntrospectedTable {
    ...
    public String getBasicName() {
        return internalAttributes.get(InternalAttribute.ATTR_BASIC_NAME);
    }

    public void setBasicName(String basicName) {
        internalAttributes.put(InternalAttribute.ATTR_BASIC_NAME, basicName);
    }

    public String getModuleName() {
        return internalAttributes.get(InternalAttribute.ATTR_MODULE_NAME);
    }

    public void setModuleName(String moduleName) {
        internalAttributes.put(InternalAttribute.ATTR_MODULE_NAME, moduleName);
    }
    ...
    public void setMyBatis3JavaServiceImplType(String myBatis3JavaServiceImplType) {
        internalAttributes.put(InternalAttribute.ATTR_MYBATIS3_JAVA_SERVICE_IMPL_TYPE, myBatis3JavaServiceImplType);
    }
