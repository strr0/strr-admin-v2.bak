...
public class Context extends PropertyHolder {
     ...
     * 自定义配置
     */
    private JavaCrudGeneratorConfiguration javaCrudGeneratorConfiguration;
    ...
    public JavaCrudGeneratorConfiguration getJavaCrudGeneratorConfiguration() {
        return javaCrudGeneratorConfiguration;
    }
    ...
    public void validate(List<String> errors) {
        ...
        if (javaCrudGeneratorConfiguration != null) {
            javaCrudGeneratorConfiguration.validate(errors, id);
        }
    ...
    public void setJavaCrudGeneratorConfiguration(JavaCrudGeneratorConfiguration javaCrudGeneratorConfiguration) {
        this.javaCrudGeneratorConfiguration = javaCrudGeneratorConfiguration;
    }
