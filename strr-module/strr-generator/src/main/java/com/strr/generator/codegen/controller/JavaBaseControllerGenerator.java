...
public class JavaBaseControllerGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        FullyQualifiedJavaType type = new FullyQualifiedJavaType(this.introspectedTable.getMyBatis3JavaControllerType());
    ...
    protected void addBasicInfo(TopLevelClass topLevelClass) {
        String basicName = this.introspectedTable.getBasicName();
        String moduleName = this.introspectedTable.getModuleName();
    ...
    protected void addBasicConstructor(TopLevelClass topLevelClass) {
        String basicName = this.introspectedTable.getBasicName();
        // service
        FullyQualifiedJavaType service = new FullyQualifiedJavaType(this.introspectedTable.getMyBatis3JavaServiceType());
